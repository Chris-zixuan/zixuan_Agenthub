...
2. **查索引** → [INDEX.md](INDEX.md) 提供全项目文件导航和功能速查
3. **找参考** → [examples/](examples/) 包含完整脚本示例、类型映射表、代码模式库

## 项目结构

```
vm-script-skill/
├── SKILL.md                 # 技能定义（v3.1.0，直接赋值范式）
├── INDEX.md                 # 文件索引与功能速查
├── README.md                # 本文件
├── assets/
...
v2.1.0 起，变量读写一律使用**直接赋值**，不使用 Get/Set 遗留接口：
