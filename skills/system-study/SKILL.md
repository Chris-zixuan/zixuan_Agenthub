...
| 阶段 | 名称 | 介入次数 | 产物 | 详细操作 |
|---|---|---|---|---|
| 1 | 题目收敛 | 1 次（必） | `01-题目确认.md` | [references/stage-1-topic-narrow.md](references/stage-1-topic-narrow.md) |
| 2 | 调研计划 | 1 次（默认） | `02-调研计划.md` | [references/stage-2-research-plan.md](references/stage-2-research-plan.md) |
| 3 | Sub-agent 并行调研 | 0 次 | `03-调研笔记/A-E.md` | [references/stage-3-subagent-templates.md](references/stage-3-subagent-templates.md) ⭐ |
| 4 | 体系搭建+大纲确认 | 1 次（默认） | `04-体系大纲.md` | [references/stage-4-synthesis.md](references/stage-4-synthesis.md) |
| 5 | HTML 学习材料 | 0 次 | `05-学习材料.html` | [references/stage-5-html-spec.md](references/stage-5-html-spec.md) |
...
详细 prompt 模板见 [references/stage-3-subagent-templates.md](references/stage-3-subagent-templates.md)。
...
- prompt 模板见 [references/stage-3-subagent-templates.md](references/stage-3-subagent-templates.md)
- **必须包含的硬约束**（见 [anti-patterns.md](references/anti-patterns.md)）：
...
### Step 5：HTML 产出
- 按 [stage-5-html-spec.md](references/stage-5-html-spec.md) 的设计 token 和组件规范
- 单文件 HTML，所有 CSS 内嵌
...
## 关键硬约束（一定要看 [anti-patterns.md](references/anti-patterns.md)）
...
- 卡点教训：见 [anti-patterns.md](references/anti-patterns.md) 的"Agent B socket 崩溃"案例
